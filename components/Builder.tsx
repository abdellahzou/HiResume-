...
import { ChevronRight, ChevronLeft, Printer, Code, Save, Layout, FileText, Download } from 'lucide-react';
              ...
              <div className="flex flex-col gap-5">
                 ...
                 <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-3 w-full md:w-auto">
                        <button onClick={handlePdfExport} className="flex-1 md:flex-none justify-center items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5">
